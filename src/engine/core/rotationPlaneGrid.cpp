...
namespace rho
{
    rotationPlaneGrid::rotationPlaneGrid() :
        component(component::ROTATION_PLANE_GRID),
        _color(color::white),
    ...
    {
        rho::removeIfContains(_clippingPlanes, plane);
