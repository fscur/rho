...
namespace rho
{
    ...
    public:
        ...
        materialDTO(rho::guid guid,
            rho::guid albedoTextureGuid,
            rho::guid normalTextureGuid,
            rho::guid specularTextureGuid,
            rho::guid emissiveTextureGuid,
            vec3 albedoColor,
            vec3 specularColor,
            vec3 emissiveColor,
            float shininess,
        ...
        static materialDTO from(rho::material* material)
        {
            return materialDTO(
                material->getGuid(),
