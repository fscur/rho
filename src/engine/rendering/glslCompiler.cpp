...
namespace rho
{
    ...
    //    switch (stage)
    //    {
    //    case rho::shaderStage::vertex:
    //        return EShLangVertex;
    //    case rho::shaderStage::tesselationControl:
    //        return EShLangTessControl;
    //    case rho::shaderStage::tesselationEvaluation:
    //        return EShLangTessEvaluation;
    //    case rho::shaderStage::geometry:
    //        return EShLangGeometry;
    //    case rho::shaderStage::fragment:
    //        return EShLangFragment;
    //    case rho::shaderStage::compute:
    ...
    //    {
    //        rho::debug(shader->getInfoLog());
    //        rho::debug(shader->getInfoDebugLog());
    //    }
    ...
    //        rho::debug("[glslCompiler::compile]: unable to link program;");
    //    
    //    for (auto shader : shaders)
    ...
    //        //rho::debug(getDataType(attributeType) + ": " + attributeName + "[" + std::to_string(attributeLocation) + "]");
    ...
    //        {
    //            //rho::debug(string(tProgram.getUniformName(i)) + "[" + std::to_string(uniformLocation)+"]");
